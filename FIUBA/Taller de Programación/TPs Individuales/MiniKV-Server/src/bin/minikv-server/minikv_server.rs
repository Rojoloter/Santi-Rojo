...
impl Minikv {
    ...
    pub fn split_words(args: String) -> Vec<String> {
    ...
    /// Inserta una clave-valor en el HashMap
    pub fn set(&mut self, k: String, v: String) {
        self.memory.insert(k, v);
    }

    /// Elimina una clave y su valor del HashMap
...
mod tests {
    ...
    fn test_split_words_basic() {
        let parts = Minikv::split_words("set velez sarsfield".to_string());
        assert_eq!(parts, vec!["set", "velez", "sarsfield"]);
    }

    #[test]
    fn test_split_words_with_quotes() {
        let parts = Minikv::split_words("set \"el fortin\" \"liniers\"".to_string());
        assert_eq!(parts, vec!["set", "el fortin", "liniers"]);
    }

    #[test]
    fn test_split_words_extra_spaces() {
        let parts = Minikv::split_words("get    velez  ".to_string());
        assert_eq!(parts, vec!["get", "velez"]);
    }
}
