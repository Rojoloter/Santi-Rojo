...
Para generar un snapshot, se deberá:
    ...
    Leer .minikv.data si existe y cargar los datos en memoria.
    Leer .minikv.log y aplicar secuencialmente todas las operaciones.
    Persistir el estado completo nuevamente en .minikv.data.
    Truncar el log .minikv.log.
