...
#define TESTED(x) (__builtin_strcmp(#x, STRING(TEST)) == 0)
	...
	// Ejemplo aumentar/disminuir la prioridad
	ENV_CREATE(user_prioritychange, ENV_TYPE_USER);

	// Ejemplos para scheduling con prioridad
	/*ENV_CREATE(user_priorityhigh, ENV_TYPE_USER);
	ENV_CREATE(user_prioritymedium, ENV_TYPE_USER);
